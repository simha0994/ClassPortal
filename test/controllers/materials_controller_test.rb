...
class MaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material" do
    assert_difference('Material.count') do
      post materials_url, params: { material: { course_id: @material.course_id, information: @material.information } }
    end
  ...
  test "should update material" do
    patch material_url(@material), params: { material: { course_id: @material.course_id, information: @material.information } }
